...
// Themed cover for the extra seed courses (Pollinations Flux, keyless, deterministic).
const polli = (prompt, seed) => `https://image.pollinations.ai/prompt/${encodeURIComponent(prompt)}?width=800&height=450&seed=${seed}&nologo=true&model=flux`
const COURSES = [
  ...
  { id: 'c_ielts7', teacher_id: 'u_emma', title: 'IELTS Band 7 Intensive', description: 'Strategy + practice for all four IELTS skills, built around full mock exams and examiner-style feedback.', level: 'B2', target_language: 'en', cover: 'from-rose-500 to-pink-700', thumbnail_url: polli('IELTS exam preparation study desk, books and headphones', 11), banner_url: null, pricing: { kind: 'free' }, rating: 0, review_count: 0, enrollment_count: 0, hours: 24, published_at: iso(60 * 24 * 7), capstone: 'Sit a full timed IELTS mock and review your band breakdown.' },
  { id: 'c_pronun', teacher_id: 'u_emma', title: 'Pronunciation & Accent', description: 'Master English sounds, word stress and intonation with shadowing drills and minimal-pair practice.', level: 'A2', target_language: 'en', cover: 'from-amber-500 to-orange-700', thumbnail_url: polli('person speaking into microphone sound waves, clean studio', 12), banner_url: null, pricing: { kind: 'free' }, rating: 0, review_count: 0, enrollment_count: 0, hours: 10, published_at: iso(60 * 24 * 5), capstone: 'Record a 2-minute monologue and score your pronunciation.' },
  { id: 'c_egiu', teacher_id: 'u_emma', title: 'English Grammar in Use', description: 'A structured tour of core English grammar — tenses, articles, conditionals — with exercises after every unit.', level: 'A2', target_language: 'en', cover: 'from-emerald-500 to-teal-700', thumbnail_url: polli('open english grammar notebook with pen, warm light', 13), banner_url: null, pricing: { kind: 'free' }, rating: 0, review_count: 0, enrollment_count: 0, hours: 18, published_at: iso(60 * 24 * 6), capstone: 'Pass the grammar mastery check covering every unit.' },
  { id: 'c_everyday', teacher_id: 'u_emma', title: 'Everyday English Conversation', description: 'The phrases and confidence for daily life — shopping, travel, small talk and making friends.', level: 'A1', target_language: 'en', cover: 'from-sky-500 to-blue-700', thumbnail_url: polli('friends chatting at a cafe table, bright and friendly', 14), banner_url: null, pricing: { kind: 'free' }, rating: 0, review_count: 0, enrollment_count: 0, hours: 12, published_at: iso(60 * 24 * 4), capstone: 'Hold a 5-minute everyday conversation with the AI tutor.' }
]

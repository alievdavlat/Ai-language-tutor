...
export default function ProductivityPage(): JSX.Element {
  const api = getApi()
    ...
    <div className="h-full overflow-y-auto">
      <div className="px-6 py-6 w-full flex flex-col gap-6">
        <PageHeader
          ...
          title="Learn without leaving your work"
          subtitle="A global lookup hotkey, a desktop widget, and a browser extension."
          back="/home"
          crumbs={[{ label: 'Home', to: '/home' }, { label: 'Productivity' }]}
        />

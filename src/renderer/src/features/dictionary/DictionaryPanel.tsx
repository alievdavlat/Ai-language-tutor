...
/**
 * The dictionary lookup + phrasebook UI, without page chrome — so it can live
 * standalone (DictionaryPage) or as a tab inside Vocabulary. Looking a word up
 * and saving it feeds the same vocab store the rest of the page uses.
 */

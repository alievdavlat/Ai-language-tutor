...
const NAV: { id: Tab; labelKey: StringKey; Icon: (p: IconProps) => JSX.Element }[] = [
  { id: 'feed', labelKey: 'social.feed', Icon: IconHome },
  { id: 'groups', labelKey: 'social.groups', Icon: IconUsers },
  { id: 'challenges', labelKey: 'social.challenges', Icon: IconTrophy },
  { id: 'explore', labelKey: 'social.discover', Icon: IconSearch }
]
  ...
  return (
    <div className="h-full overflow-y-auto">
      ...
      <div className="px-6 pt-5 pb-3">
        <h1 className="text-2xl font-black tracking-tight">{t('social.explore')}</h1>
      </div>
